...
const CITY = {
  ...
  /* The rest of the league's home cities. Each carries its own signature-tower
     table so the silhouettes differ; the shading and window system is shared. */
  PHX: { sky: '#4a2c30', marks: [[0.2, 'box', 0.52, 0.062], [0.36, 'setback', 0.78, 0.058], [0.52, 'box', 0.62, 0.07], [0.7, 'cyl', 0.56, 0.044], [0.84, 'box', 0.48, 0.058]] },
  ATL: { sky: '#38243a', marks: [[0.18, 'box', 0.56, 0.058], [0.32, 'deco', 0.94, 0.054], [0.48, 'cyl', 0.72, 0.046], [0.64, 'setback', 0.8, 0.06], [0.8, 'box', 0.58, 0.06]] },
  BUF: { sky: '#26303f', marks: [[0.22, 'box', 0.5, 0.06], [0.38, 'deco', 0.86, 0.056], [0.56, 'setback', 0.66, 0.062], [0.74, 'box', 0.54, 0.058]] },
  CLT: { sky: '#1f3448', marks: [[0.22, 'box', 0.58, 0.06], [0.38, 'spire', 0.92, 0.05], [0.54, 'setback', 0.74, 0.062], [0.72, 'box', 0.56, 0.058], [0.86, 'box', 0.46, 0.05]] },
  CIN: { sky: '#3a2a26', marks: [[0.2, 'box', 0.54, 0.06], [0.36, 'deco', 0.84, 0.056], [0.54, 'setback', 0.7, 0.064], [0.72, 'box', 0.52, 0.056]] },
  CLE: { sky: '#26313c', marks: [[0.22, 'box', 0.52, 0.06], [0.38, 'deco', 0.9, 0.058], [0.56, 'setback', 0.68, 0.062], [0.74, 'box', 0.5, 0.056]] },
  DEN: { sky: '#332a44', marks: [[0.2, 'box', 0.56, 0.06], [0.36, 'cyl', 0.84, 0.048], [0.52, 'setback', 0.72, 0.064], [0.7, 'box', 0.6, 0.06], [0.84, 'spire', 0.5, 0.034]] },
  DET: { sky: '#22303f', marks: [[0.2, 'box', 0.5, 0.058], [0.36, 'cyl', 0.94, 0.056], [0.46, 'cyl', 0.72, 0.04], [0.62, 'setback', 0.66, 0.06], [0.8, 'box', 0.5, 0.056]] },
  GB: { sky: '#26332a', marks: [[0.26, 'box', 0.44, 0.064], [0.46, 'setback', 0.58, 0.068], [0.66, 'box', 0.48, 0.06], [0.82, 'box', 0.38, 0.054]] },
  HOU: { sky: '#1d2c38', marks: [[0.18, 'box', 0.56, 0.058], [0.34, 'setback', 0.9, 0.062], [0.5, 'box', 0.68, 0.066], [0.68, 'deco', 0.74, 0.052], [0.84, 'box', 0.5, 0.056]] },
  IND: { sky: '#232c40', marks: [[0.22, 'box', 0.52, 0.06], [0.4, 'deco', 0.88, 0.056], [0.58, 'setback', 0.66, 0.062], [0.76, 'box', 0.5, 0.056]] },
  JAX: { sky: '#1f3536', marks: [[0.24, 'box', 0.48, 0.06], [0.42, 'setback', 0.76, 0.062], [0.6, 'box', 0.58, 0.058], [0.78, 'box', 0.44, 0.054]] },
  KC: { sky: '#3a2c2e', marks: [[0.2, 'box', 0.5, 0.06], [0.38, 'deco', 0.86, 0.058], [0.56, 'setback', 0.68, 0.062], [0.74, 'box', 0.52, 0.056]] },
  LV: { sky: '#3d3220', marks: [[0.18, 'box', 0.46, 0.056], [0.32, 'pyramid', 0.72, 0.07], [0.5, 'spire', 1.0, 0.03], [0.66, 'box', 0.6, 0.062], [0.84, 'cyl', 0.54, 0.044]] },
  MSP: { sky: '#2a2c48', marks: [[0.22, 'box', 0.54, 0.06], [0.4, 'setback', 0.88, 0.062], [0.56, 'cyl', 0.7, 0.046], [0.74, 'box', 0.56, 0.058], [0.88, 'box', 0.44, 0.05]] },
  BOS: { sky: '#25293e', marks: [[0.2, 'box', 0.54, 0.058], [0.36, 'setback', 0.84, 0.06], [0.52, 'box', 0.92, 0.05], [0.7, 'deco', 0.66, 0.052], [0.86, 'box', 0.48, 0.054]] },
  NOLA: { sky: '#33283c', marks: [[0.22, 'box', 0.5, 0.06], [0.4, 'setback', 0.78, 0.062], [0.58, 'cyl', 0.62, 0.05], [0.76, 'box', 0.48, 0.056]] },
  PIT: { sky: '#2b2a36', marks: [[0.18, 'box', 0.52, 0.058], [0.34, 'deco', 0.92, 0.056], [0.5, 'setback', 0.72, 0.064], [0.68, 'box', 0.56, 0.058], [0.84, 'box', 0.44, 0.05]] },
  SF: { sky: '#3a2c3e', marks: [[0.18, 'box', 0.5, 0.056], [0.32, 'pyramid', 0.96, 0.056], [0.5, 'box', 0.7, 0.064], [0.68, 'setback', 0.64, 0.058], [0.84, 'box', 0.5, 0.054]] },
  TPA: { sky: '#2c3446', marks: [[0.24, 'box', 0.48, 0.058], [0.42, 'setback', 0.76, 0.062], [0.6, 'box', 0.58, 0.058], [0.78, 'cyl', 0.46, 0.044]] },
  NSH: { sky: '#28304a', marks: [[0.22, 'box', 0.48, 0.058], [0.4, 'twin', 0.94, 0.05], [0.58, 'setback', 0.68, 0.062], [0.76, 'box', 0.5, 0.056]] },
  DC: { sky: '#2e2c3a', marks: [[0.16, 'box', 0.4, 0.06], [0.3, 'box', 0.36, 0.066], [0.46, 'spire', 0.98, 0.026], [0.64, 'box', 0.42, 0.07], [0.82, 'box', 0.38, 0.062]] },
};
