// PIECE: character-anatomy
// OWNER: this directory ONLY. Never edit anything outside src/pieces/character-anatomy/.
// SLOT:  world.anatomy
// REGISTER VIA: registerWorld('anatomy', impl)
// JUDGED ON: player silhouette, pad bulk, helmet form, proportion by archetype
// HERO PANELS: truck, leveler
//
// ---------------------------------------------------------------------------
...
//   import { makeSkeleton, BONES, SOCKETS, PROPORTIONS } from '../../foundation/rig.js';
//   // registerWorld('anatomy', { piece:PIECE, build(ctx, o){...}, setMaterials(actor, matSet){...} });
//
...
//   registerIsoShot('iso:character-anatomy', {
//     piece: PIECE,
...
//
// 4. Capture:
//   node scripts/shoot.mjs --piece=character-anatomy
//   node scripts/shoot.mjs --scene=truck --out=shots/character-anatomy/truck.png
//   node scripts/shoot.mjs --scene=leveler --out=shots/character-anatomy/leveler.png
//   node scripts/compare.mjs --panel=truck --shot=shots/character-anatomy/truck.png --out=shots/character-anatomy/cmp.png
//
