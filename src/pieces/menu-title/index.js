...
// SLOT:  ui.title
// REGISTER VIA: registerUI('title', impl)
...
//   // registerUI('title', { piece:PIECE, draw(c2d, t, state, ui){...} });
//
...
//   registerIsoShot('iso:menu-title', {
//     piece: PIECE,
...
//   node scripts/shoot.mjs --scene=title --out=shots/menu-title/title.png
//   node scripts/compare.mjs --panel=title --shot=shots/menu-title/title.png --out=shots/menu-title/cmp.png
//
